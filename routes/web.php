...
use App\Http\Controllers\RekomendasiAlatController;
...
Route::middleware(['auth','superuser'])->group(function () {
    ...
    // Subkategori
    Route::get('/admin/subkategori',[SubcategoryController::class,'index'])->name('subkategori.index');
    Route::post('/admin/subkategori',[SubcategoryController::class,'store'])->name('subkategori.store');
    Route::get('/admin/subkategori/{id}/edit',[SubcategoryController::class,'edit'])->name('subkategori.edit');
    Route::patch('/admin/subkategori/{id}',[SubcategoryController::class,'update'])->name('subkategori.update');
    Route::delete('/admin/subkategori/{id}',[SubcategoryController::class,'destroy'])->name('subkategori.destroy');
});
...
Route::middleware('auth')->group(function() {
    ...
    Route::get('/rentals/{id}',[OrderController::class,'rentals'])->name('rentals.show');
    ...
    Route::get('/subkategori',[SubcategoryController::class,'show'])->name('subkategori.show');

    //rating
    Route::get('/memberarea/rate_alat', function () {
        // Ambil data alat dari database dan lewatkan ke view form pemberian rating
        $userRating = \App\Models\Alat::all();
        return view('member.rate_alat', compact('userRating'));
    })->name('member.rate_alat');
    Route::post('/ratings', [UserRatingController::class, 'store'])->name('user-ratings.store');

    //rekomendasi
    Route::get('/memberarea/rekomen', function () {
        // Ambil data alat dari database dan lewatkan ke view form pemberian rating
        $rekomenAlat = \App\Models\Rating::All();
        return view('member.rekomen', compact('rekomenAlat'));
    })->name('member.rekomen');
});
