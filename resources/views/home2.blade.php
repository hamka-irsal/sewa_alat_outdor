    ...
    <body>
        ...
        <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
            <div class="col-md-5 p-lg-5 mx-auto my-3">
                <h1 class="display-4 fw-normal">CV. Setia Outdoor</h1>
...
<div class="container">
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">
            {{ $alat->nama_alat }} - {{ $alat->deskripsi }}
            @if ($userRating = $alatRating->where('alat_id', $alat->id)->first())
                <span class="badge badge-primary">Peringkat: {{ $userRating->rating }}</span>
            @endif
            <form action="/rate/{{ Auth::user()->id }}/{{ $alat->id }}/" method="POST" style="display: inline;">
                @csrf
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">{{ $alat->nama_alat }} - {{ $alat->deskripsi }}</li>
        @endforeach
    </ul>
</div>
@endsection --}}
        ...
        <footer class="py-5 bg-dark">
            <div class="container px-4"><p class="m-0 text-center text-white">&copy; 2023 CV Setia Outdoor</p></div>
        </footer>
